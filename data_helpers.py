...
POS_DATASET_PATH = 'data-csv/tw-data.pos'
NEG_DATASET_PATH = 'data-csv/tw-data.neg'
NEU_DATASET_PATH = 'data-csv/tw-data.neu'
VOC_PATH = 'data-csv/vocab.csv'
VOC_INV_PATH = 'data-csv/vocab_inv.csv'
...
def load_data_and_labels(reduced_dataset):
    ...
    print "\tdata_helpers: [OK]"
    print "\tdata_helpers: loading neutral examples..."
    neutral_examples = list(open(NEU_DATASET_PATH).readlines())
    ...
    neutral_examples = sample_list(neutral_examples, reduced_dataset)
